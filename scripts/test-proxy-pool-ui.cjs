...
const status=()=>({version:'0.3.2',mode:'force',valid_count:0,prefer_292:true,probe_enabled:true,continuous:true,retry_seconds:15,proxy_mode:enabled?'pool':'credential',reasoning_effort:'medium',selection:{required:true,persistent:true,revision:1,models:[],model_options:['gpt-6-astra'],accounts:[]},entries:[],history:[],proxy_pool:{enabled,revision,entries,persistent:true}});
