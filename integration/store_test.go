...
func TestRealCPAStoreInstallWithoutPluginParameters(t *testing.T) {
	...
	s := read()
	if s.Version != "0.3.3" || s.Mode != "force" || s.Guard || !s.Probe || !s.Continuous || !s.Parallel || !s.Selection.Persistent {
